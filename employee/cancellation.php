                        ...
                        <div class="row">
                          <div class="col-12">
                            <div class="mb-3">
                              ...
                              <input type="text" name="update_rsvn_no" id="rsvn_no" class="form-control"
                                value="<?php echo $rowReserveCancel->rsvn_no ?>" required>
                          ...
                          <div class="col-12">
                            <div class="mb-3">
                              ...
                              <input type="date" name="update_date_from" id="updateDateFrom" class="form-control"
                                value="<?php echo $rowReserveCancel->date_from ?>" required>
                              <div class="invalid-feedback">
                          ...
                          <div class="col-12">
                            <div class="mb-3">
                              ...
                              <input type="date" name="update_date_to" id="updateDateTo" class="form-control"
                                value="<?php echo $rowReserveCancel->date_to ?>" required>
                              <div class="invalid-feedback">
                          ...
                          <div class="col-12">
                            <div class="mb-3">
                              ...
                              <input type="time" name="update_time_from" id="updateTimeFrom" class="form-control"
                                value="<?php echo $rowReserveCancel->time_from ?>" required>
                              <div class="invalid-feedback">
                          ...
                          <div class="col-12">
                            <div class="mb-3">
                              ...
                              <input type="time" name="update_time_to" id="updateTimeTo" class="form-control"
                                value="<?php echo $rowReserveCancel->time_to ?>" required>
                              <div class="invalid-feedback">
                          ...
                          <div class="col-12">
                            ...
                            <input type="text" name="update_status" class="form-control" id="status" value="PENDING"
                              readonly>
                          </div>
                        </div>
                      </div>

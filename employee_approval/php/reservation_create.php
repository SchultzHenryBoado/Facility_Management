...
if (isset($_POST['submit'])) {
  ...
  $sqlReservationCreate = "INSERT INTO reservations (users_id, created_date, rsvn_no, created_by, room_type, room_number, date_from, date_to, time_from, time_to, statuses) 
    VALUES (?, curdate(), ?, ?, ?, ?, ?, ?, ?, ?, ?)";

              ...
              <tr>
                ...
                <td>
                  <div class="d-inline-block">
                    <!-- UPDATE FACILITIES -->
                    <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#updateModal-<?php echo $rowFacility->id ?>">
                              ...
                              <div class="row">
                                <div class="col-12">
                                  <div class="mb-3">
                                    ...
                                    <input type="text" name="update_facility_code" id="updateFacilityCode" class="form-control" value="<?php echo $rowFacility->facility_code ?>" required>
                                    <div class="invalid-feedback">
                                      Please fill-up the facility code.
                                    </div>
                                  </div>
                                ...
                                <div class="col-12">
                                  <div class="mb-3">
                                    ...
                                    <input type="text" name="update_facility_name" id="updateFacilityName" class="form-control" value="<?php echo $rowFacility->facility_name ?>" required>
                                    <div class="invalid-feedback">
                                      Please fill-up the facility name.
                                    </div>
                                  </div>
                  ...
                  <div class="d-inline-block">
                    ...
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal-<?php echo $rowFacility->id ?>">

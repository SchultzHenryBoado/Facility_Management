            ...
            <tbody>
              <?php while ($rowUsers = $stmtUsers->fetch()) { ?>
                <tr>
                  ...
                  <td>
                    <!-- UPDATE -->
                    <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#updateModal-<?php echo $rowUsers->id ?>">
                              ...
                              <div class="row">
                                ...
                                <div class="col-12">
                                  <div class="mb-3">
                                    ...
                                    <input type="text" name="update_last_name" id="lastName" class="form-control" value="<?php echo $rowUsers->last_names ?>" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                  <div class="mb-3">
                                    ...
                                    <input type="text" name="update_first_name" id="firstName" class="form-control" value="<?php echo $rowUsers->first_names ?>" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                  <div class="mb-3">
                                    <label for="email" class="form-label">Company Email</label>
                                    <input type="email" name="update_email" id="email" class="form-control" value="<?php echo $rowUsers->emails ?>" required>
                                    <div class="invalid-feedback">
                                      Please fill-up the email.
                                    </div>
                                  </div>
                                ...
                                <div class="col-12">
                                  <div class="mb-3">
                                    <label for="password" class="form-label">Password</label>
                                    <input type="password" name="update_password" id="password" class="form-control" value="<?php echo $rowUsers->passwords ?>" required>
                                    <div class="invalid-feedback">
                                      Please fill-up the password.
                                    </div>
                                  </div>
